...
function App() {
    ...
    const getConfig = async () => {
        ...
        let readContract = new rp.eth.Contract(abi, config.CONTRACT_ADDRESS);

        let supply = await readContract.methods.totalSupply().call()
    ...
    useEffect(() => {
        getConfig();
        //* setReadProvider(new Web3 (new Web3. providers. HttpProvider("https://mainnet.infura.io/v3/49f33bd19db84f7a94a0762841982e9c")))
    }, []);
